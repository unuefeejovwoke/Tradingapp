...
SECRET_KEY = 'django-insecure-)n6%#a^a2qmqk-toyh&z6js7d^47%6_@01&3$^5nh0w8+c*eeu'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'trader_dashboard_db',
        'ENFORCE_SCHEMA': False,
        'CLIENT': {
            'host': 'mongodb+srv://Trader:tester123#@cluster0.xyhaq3j.mongodb.net/?retryWrites=true&w=majority'
        }  
    }
}
